...
//	private static String TEMP_DIR = configFile.getProperty("tempDirFor" + osName);
        private static String TEMP_DIR = "C:/Users/Fateme/workspace/DS_FinalProject";
	/**
	 * Where is your dot program located? It will be called externally.
	 */
//	private static String DOT = configFile.getProperty("dotFor" + osName);
        private static String DOT = "C:/Users/Fateme/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Graphviz 2.38/bin/dot.exe";
	...
	public byte[] getGraph(String dot_source, String type, String representationType)
	{
		...
		try {
			...
			System.out.println("haha dot is null");
			return null;
